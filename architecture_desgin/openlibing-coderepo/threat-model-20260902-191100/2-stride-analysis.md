...
_No Tier 1 threats identified. 所有入站流量经华为云 APIG IP 白名单与限流，应用层 HMAC 签名校验构成双重屏障，无前置条件的直接暴露面被关闭。_
...
_No Tier 1 threats identified. REST 接口经 APIG 网关用户 token 鉴权，无未认证直接暴露面。_
...
_No Tier 3 threats identified for this repository._
...
_No Tier 1 threats identified. 管理接口经 APIG 网关鉴权 + 角色权限校验。_
...
_No Tier 1 threats identified. 同步接口经 APIG 鉴权。_
...
_No Tier 1 threats identified. 查询接口经 APIG 鉴权。_
...
_No Tier 1 threats identified. 该服务为内部 Service，无独立监听端口，仅被 Controller/Consumer 调用。_
...
_No Tier 1 threats identified. 消费者从 RabbitMQ 队列消费，需 Internal Network 访问消息队列。_
...
_No Tier 1 threats identified. 执行器通过 XXL-Job SDK 与调度中心通信，需 Internal Network 访问调度中心。_
...
_No Tier 1 threats identified. MySQL 为云数据库内网访问，需 Internal Network。_
...
_No Tier 1 threats identified. MongoDB 为云数据库内网访问，需 Internal Network。_
...
_No Tier 1 threats identified. Redis 为云缓存内网访问且启用 SSL 与密码认证，需 Internal Network。_
...
_No Tier 1 threats identified. RabbitMQ 为云消息队列内网访问，需 Internal Network。_
...
_No Tier 1 threats identified. GitCode 为外部第三方平台，从本系统视角为外部服务，攻击面由平台侧保障。_
...
_No Tier 1 threats identified. Gitee 为外部第三方平台。_
...
_No Tier 1 threats identified. Github 为外部第三方平台。_
...
_No Tier 1 threats identified. Nacos 为云服务内网访问，需 Internal Network。_
...
_No Tier 1 threats identified. XXLJob 调度中心为内网访问，需 Internal Network。_
...
_No Tier 1 threats identified. OBS 为云对象存储，访问需 AK/SK 签名认证。_
