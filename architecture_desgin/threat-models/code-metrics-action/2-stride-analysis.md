...
*No Tier 1 threats identified for this component. CI_RUNNER deployment classification forbids T1 — runner 是 GitCode 平台调度的 ephemeral 容器，外部攻击者需先经 GitCode 认证并具备提交代码/配置 workflow 权限才能影响此组件的执行。*
...
*No Tier 1 threats identified for this component. CI_RUNNER 部署，无外部攻击面。*
...
*No Tier 3 threats identified for this component. MetricsScanner 是进程内编排器，无独立基础设施访问，无多重 prerequisite 触发的威胁。*
...
*No Tier 1 threats identified for this component. CI_RUNNER 部署，scc 二进制由插件打包，无外部监听。*
...
*No Tier 1 threats identified for this component. CI_RUNNER 部署。*
...
*No Tier 3 threats identified for this component. 进程内计算，无外部基础设施访问。*
...
*No Tier 3 threats identified for this component. 静态配置加载器。*
...
*No Tier 3 threats identified for this component. 静态工具类。*
...
*No Tier 1 threats identified for this component. CI_RUNNER 部署，runner 是平台调度。*
...
*No Tier 1 threats identified for this component. WorkspaceRepo 在 runner 进程内访问，外部攻击者需先经 GitCode 认证并提交 PR 才能 influence 内容。*
...
*No Tier 3 threats identified for this component. 静态文件系统数据存储。*
...
*No Tier 1 threats identified for this component. 文件系统数据存储，runner 进程内访问。*
...
*No Tier 1 threats identified for this component. 临时目录在 runner 进程内访问。*
...
*No Tier 3 threats identified for this component. 临时文件系统数据存储。*
...
*No Tier 1 threats identified for this component. OBS 端点需凭证（STS 或 AK/SK）才能写入，公开 HTTPS 仅校验证书，无匿名写入路径。*
...
*No Tier 1 threats identified for this component. APIG 端点需签名（HMAC 或 OIDC）才能调用 /metrics/code/report。*
...
*No Tier 1 threats identified for this component. OIDC 端点需 runner 上下文（`ACTIONS_ID_TOKEN_REQUEST_URL` + 平台 token）才能换证。*
...
*No Tier 3 threats identified for this component. 公开镜像源，无基础设施级攻击面。*
...
*No Tier 3 threats identified for this component. 公开 PyPI 镜像，无基础设施级攻击面。*
