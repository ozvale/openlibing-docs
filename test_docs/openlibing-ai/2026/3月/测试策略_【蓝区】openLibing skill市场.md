# #1 【蓝区】openLibing skill市场 测试策略设计说明书
...
* 测试步骤：
* 1.查看无用户角色权限时，skillhub界面是否可见
* 2.增加skillhub用户角色权限时，skillhub界面是否可见
* 预期结果：
* 1.“AI工具管理”的下级菜单中“skillhub”不可见
* 2.用户角色添加成功，可见“AI工具管理”的下级菜单“skillhub”

**1.用户角色页面操作功能可用验证**: 
* 前置条件：已添加skillhub用户权限
* 测试步骤：
* 1.已有skillhub用户角色权限时，skillhub页面切换验证
* 2.已有skillhub用户角色权限时，skillhub界面功能可用性验证
* 预期结果：
* 1.skillhub页面切换正常
* 2.skillhub界面功能正常可用
