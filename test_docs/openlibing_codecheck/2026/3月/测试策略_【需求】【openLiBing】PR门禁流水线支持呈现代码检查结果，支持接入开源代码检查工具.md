# #1 【需求】【openLiBing】PR门禁流水线支持呈现代码检查结果，支持接入开源代码检查工具 测试策略设计说明书
...
* **核心目标**:
  PR门禁流水线支持呈现代码检查结果，支持接入开源代码检查工具。
* **开发责任人**: 陶获权
* **测试责任人**: 徐愚冰
...
* 1.创建一个PR
* 2.触发PR门禁流水线
* 3.查看流水线执行结果，确认代码检查结果是否正确呈现
* 预期结果：
* PR门禁流水线正确呈现代码检查结果，包括告警数量、严重程度等信息
...
* 2.配置开源代码检查工具
* 3.创建PR触发流水线
* 4.查看代码检查结果是否包含开源工具的检查结果
* 预期结果：
* 成功接入开源代码检查工具，代码检查结果包含开源工具的检查结果
