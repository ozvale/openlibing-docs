# #1 【需求】【openLiBing】代码检查已忽略告警补全屏蔽提交人，审核人、时间等信息 测试策略设计说明书
...
* 1.进入版本级检查页面
* 2.选择一条存在屏蔽告警的代码仓
* 3.查看屏蔽告警的提交人、审核人、时间等信息
* 预期结果：
* 查看到屏蔽告警的提交人、审核人、时间等信息
...
* 1.进入版本级检查页面
* 2.选择一条存在屏蔽告警的代码仓
* 3.点击请求导出、导出问题按钮，查看导出的文件内容
* 预期结果：
* 导出成功，文件内容包含屏蔽告警的提交人、审核人、时间等信息
