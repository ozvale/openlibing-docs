...
* **需求名称**: [需求]: openLiBing提供通用版本发布工程平台，支撑社区版本在线发布，流程可追溯
* **开发责任人**: lidebin
...
> 本需求支持一次性将多个包发布到多个代码仓发行版


## 3 需求验收标准
> 一次发布评审可以将多个包发布到多个代码仓发行版

## 4. 需求设计与分解

> 1.将当前的一个发布评审单对应一个发布基础信息修改为对应多个基础信息
> 2.构建信息读取

### 4.1 核心逻辑方案

> 1.将当前的一个发布评审单对应一个发布基础信息修改为对应多个基础信息
> 2.后续病毒扫描，sha256值校验，发布等步骤均对多个发布基本信息进行处理
![img.png](img.png)
![img_1.png](img_1.png)
### 4.2 任务清单
...
|-------|----------------------------------|---------------------|-----------|
| #1    | 新增表release_ artifact_info_ table | 代码             | 1         |
| #2    | 保存发布制品信息调整                       | 核心逻辑代码 | 2         |
| #3    | 消费发布制品信息调整                       | 核心逻辑代码  | 2         |
| #4    | 前端页面及交互调整                        | 核心逻辑代码  | 4         |
