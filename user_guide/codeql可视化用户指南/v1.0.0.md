...
> ⚠️ **注意**：示例中的 `jdk-version: 21`、`maven-version: '3.8.9'` 等版本号仅为演示用途，**请根据自己代码仓库实际所需的语言/构建工具版本填写**，不要直接照抄示例中的数字。版本不匹配可能导致 `autobuild` / `manual` 构建失败，进而影响 CodeQL 分析结果的准确性。
...
![](./images/查看日志路径-step1.png)

![](./images/查看日志路径-step2.png)
