...
```json
{
  "testcase": [{ "number": "TC_001", "ScriptName": "test_script" }],
  "userconfig": {
    "param1": "value1"
  },
...
[
  {
    "testcase": [{ "number": "TC_001", "ScriptName": "script_a" }],
    "userconfig": { "param1": "value1" },
    "testPaths": ["scripts/module_a/"]
  },
  {
    "testcase": [{ "number": "TC_002", "ScriptName": "script_b" }],
    "userconfig": { "param2": "value2" },
    "testPaths": ["scripts/module_b/"]
  },
  {
    "testcase": [{ "number": "TC_003", "ScriptName": "script_c" }],
...
| 列表格式    | 第一个元素 + config_list 传递 | config0__.uts, config1__.uts, ... | len(config_list) |
