...
| `cache/src/main/java/org/opensourceway/sbom/cache/config/ConfigContextInitializer.java` | 删除 | 原 trustStore 加载类；迁移后 trustStore 仍由启动脚本 JVM 参数加载，删除仅因 Spring 层初始化器冗余 |
